class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        let cardWidth = this.scale.width > 768 ? 300 : 100; // Further reduce width for mobile
        let cardHeight = this.scale.height > 768 ? 400 : 150; // Further reduce height for mobile
